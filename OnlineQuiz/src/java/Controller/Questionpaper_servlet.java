 ...
 * @author User
 */
public class Questionpaper_servlet extends HttpServlet {
    private int count;
        ...
        try {
            ...
            if(button.equals("submit1"))
            {
                ...
                _InsertBean.setOption2(option2);
                 ...
                 ArrayList result=_InsertModel.getData2("id");


              if(button.equals("catch_data"))
            {
                ArrayList data=_InsertModel.getData2(id);
